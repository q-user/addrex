...
@pytest.mark.asyncio
async def test_create_address_contract_valid_response():
...
@pytest.mark.asyncio
async def test_create_address_contract_conflict_response():
...
@pytest.mark.asyncio
async def test_create_address_contract_validation_error():
    """Contract test for POST /address/{phone_number} - validation error response."""
    test_payload = {
        "address": {
            "street": "A",  # Too short
            "city": "Anytown",
